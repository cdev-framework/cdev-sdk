...
class Workspace():
    ...
    @wrap_phase(Workspace_State.INITIALIZED)
    def create_state_differences(self, desired_state: List[ComponentModel], previous_state_components: List[str]) -> Tuple[Component_Difference, Resource_Reference_Difference, Resource_Difference]:
        """
        ...
        return backend.create_differences(resource_state_uuid, desired_state, previous_state_components)
